  ...
  return (
    <div className="overflow-x-auto bg-white p-4 rounded-lg shadow">
      ...
      <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-[19px]'>
        <p className="text-sm font-medium"> لیست علاقمندی شما</p>
      ...
      <div className="overflow-y-auto">
        ...
        <div className="hidden sm:flex bg-[#F1F1F1] text-[#707070] rounded-[16px] gap-[30px] p-3 text-sm font-yekan-600 whitespace-nowrap min-w-[600px]">
          ...
          <p className="w-[13%]">قیمت کل</p>
                    <p className="w-[19%]">آدرس</p>
          ...
          {reservations.length === 0 ? (
            ...
            reservations.map((item) => (
              ...
              >
                ...
                <div className="w-full sm:w-[20%] font-yekan-600 truncate">{item.fullName}</div>
                <div className="w-full sm:w-[65%] font-yekan-600 truncate">{item.lastUpdate}</div>
                <div className="w-full sm:w-[50%] px-2 py-1 flex items-center justify-center ">
                </div>
              </div>
            ))
          )}

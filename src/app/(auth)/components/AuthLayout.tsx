    ...
    switch (mode) {
      case "register":
        return {
          ...
          description:
            "با ساخت حساب کاربری به جمع ما بپیوندید و از امکانات ویژه بهره‌مند شوید !",
        };
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8 w-full lg:h-screen">
        <div className="w-full max-w-[588.25px] flex flex-col justify-center">
          <div className="flex flex-col gap-4 sm:gap-6 pb-6 sm:pb-8 text-right">
            <h4 className="text-[14px] sm:text-[16px] font-medium text-[#8CFF45]">
              {titles.welcome}
            </h4>
            <h3 className="text-xl sm:text-2xl lg:text-[32px] font-light text-white">
              {titles.main}
            </h3>
            <p className="text-[12px] sm:text-sm lg:text-[16px] font-medium text-white">
              {titles.description}
            </p>
          </div>
          ...
          {showSocialButtons && mode !== "forgot-password" && (
            <>
              ...
              <div className="relative flex items-center justify-center my-6 sm:my-8">
                ...
                <span className="mx-3 sm:mx-4 text-[#AAAAAA] text-sm">
                  یا میتونید
                </span>

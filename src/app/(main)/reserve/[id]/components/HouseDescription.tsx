...
const HouseDescription = () => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 sm:gap-8 w-full px-4 sm:px-6 lg:px-10">
      <div className="w-full max-w-full sm:max-w-[999px] h-[52px] rounded-2xl bg-[#393939] flex flex-wrap sm:flex-nowrap items-center justify-start gap-2 sm:gap-6 px-2">
        <button
      ...
      <div className="w-full max-w-full sm:max-w-[1080px] rounded-2xl flex flex-col lg:flex-row items-start justify-center overflow-hidden px-4 sm:px-8 py-6 gap-6 sm:gap-8">
        {activeTab === "about" && (
          <div className="flex flex-col gap-6 w-full">
            <div className="w-full sm:w-[466px] h-[30px] rounded-md text-sm sm:text-base">
              بهترین سبک طراحی وبسایت در سال 2024 چیست ؟
            </div>
            <div className="w-full sm:w-[999px] h-[108px] rounded-md text-xs sm:text-sm">
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است گرها و متون بلکه روزنامه و مجله در ست...لورم ایپسوم متن ساختگی با تولید سادگی نامف...لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است گرها و متون بلکه روزنامه و مجله ست...لورم ایپسوم متن ساختگی با تولید سادگی نامف...لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت.....
            </div>
            <div className="flex flex-col sm:flex-row justify-between gap-6 w-full">
              <div className="w-full sm:w-[445px] h-[391px] rounded-[64px] border border-[#555] shadow-[0px_8px_32px_0px_#00000029]"></div>
              <div className="w-full sm:w-[534px] h-[391px] rounded-[64px] border border-[#555] shadow-[0px_8px_32px_0px_#00000029]"></div>
            </div>
            <div className="w-full sm:w-[466px] h-[30px] rounded-md text-sm sm:text-base">
              بهترین سبک طراحی وبسایت در سال 2024 چیست ؟
            </div>
        ...
        {activeTab === "features" && (
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 sm:gap-4 w-full justify-items-center">
            {Array.from({ length: 21 }).map((_, i) => (
              <div
                key={i}
                className="w-full sm:w-[127.4px] h-[94px] bg-[#3F3F3F] rounded-[16px] flex items-end justify-center"
              >
                <div
                  className="w-full sm:w-[111.41px] h-[37px] rounded-[10px] bg-[#7569FF] my-5"
                  style={{
                    boxShadow: `
        ...
        {activeTab === "reviews" && (
          <div className="flex flex-col gap-8 w-full items-center">
            ...
            <div className="w-full h-[400px] sm:h-[400px] border-2 border-[#AAAAAA] rounded-2xl mt-6"></div>
          </div>
        )}
      </div>
    </section>
